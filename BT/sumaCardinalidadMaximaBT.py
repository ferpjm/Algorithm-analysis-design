...
def BTMejor(numeros, n, numObjetivo, solucion, sumaQueLLevamos, cuantoQueda, solucionMejor,etapa):
    for intento in range(0,2):
        if (intento==1 and etapa<n-1 and (sumaQueLLevamos[0]+numeros[etapa]<numObjetivo) or
                (intento == 1 and etapa== n - 1 and (sumaQueLLevamos[0] + numeros[etapa] == numObjetivo)) or
